...
function choose() {
 ...
 document.getElementById("left").addEventListener("click", toggle);
document.getElementById("right").addEventListener("click", choose);
...
//    }
    ...
    if (e.keyCode === 13 && dead) {
        ...
        blocks[0].x = 0;
        blocks[0].y = screenHeight - 20;
        blocks[0].width = screenWidth;
        blocks[0].monster = 0;
        blocks[0].type = 0;
        blocks[0].powerup = 0;
